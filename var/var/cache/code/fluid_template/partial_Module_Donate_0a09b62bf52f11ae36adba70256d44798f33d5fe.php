...
class partial_Module_Donate_0a09b62bf52f11ae36adba70256d44798f33d5fe extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array3 = array();
$array4 = array (
);$array3['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('primary', $array4)]);

...
class partial_Module_ListItem_TypeIcon_e32f240cd5cf61282796e9f72ced064f0f71e8d3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments27 = array();
$arguments27['path'] = NULL;
$arguments27['extensionName'] = NULL;
$arguments27['absolute'] = false;
$arguments27['path'] = 'Icons/ext_icon_white.png';

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\Uri\ResourceViewHelper::renderStatic($arguments27, $renderChildrenClosure28, $renderingContext)]);
